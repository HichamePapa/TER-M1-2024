...
public class testConverter {
    ...
    public void testNullQuery(){
        ...
        c = new Converter( list, "chemin", null , null);
        listQuerries = c.ConvertToPrologQuery();
        String queryExpected = "?− legal(P, D, C, T G, T).";
    ...
    public void testQueryWithValues(){
        ...
        c = new Converter( list, "chemin", "dateDeNaissance" , "Alex");
        listQuerries = c.ConvertToPrologQuery();

        String queryExpected1 = "?− legal(P, dateDeNaissance, C, T G, T).";
    ...
    public void testNumberQueries(){
        ...
        c = new Converter(list,"path", "prenom", "bob");
        listQuerries = c.ConvertToPrologQuery();
    ...
    public void testIncompatibleQuery(){
        ...
        c = new Converter(list,"path", null, null);
        listQuerries = c.ConvertToPrologQuery();
        String queryExpected = "?− legal(P, D, C, T G, T).";
