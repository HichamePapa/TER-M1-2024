...
wasGeneratedBy('consent_David_2','update','consent', 30).
used('updateConsent','consent_David_2','consent', 31).
...
wasControlledBy('sendAnalysisCookie','DC','owner', 3004, 3008).
wasGeneratedBy('analysis_cookie','sendAnalysisCookie','cookie to send', 3005).
used('sendAnalysisCookie','id_David_1','user id', 3006).
used('sendAnalysisCookie','analysis_cookie','cookie', 3008).

used('sendTicket','ticketReply','ticket reply sent', 3009).
